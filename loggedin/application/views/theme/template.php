   ...
   <body class="fixed-left">
      ...
      <div id="wrapper">
         ...
         <div class="topbar">
            ...
            <div class="topbar-left">
               <div class="text-center">
				  ...
				  <img src="<?php echo base_url('assets/loggedin_images/thime/logo_admin_panel.png'); ?>" height="50" class="big_logo"></a>                  
               </div>
            </div>
         ...
         <footer class="footer">
            ...
            <span class="text-right download">Download LoggedIn App:
